...
requirements = gTTS==2.5.4, Kivy==2.3.1, KivyGradient==0.0.5, kivymd==1.0.2, pydub==0.25.1, exceptiongroup, asynckivy, asyncgui, materialyoucolor, android, materialshapes
